...
namespace _12obj
{
    internal class Program
    {
        ...
        private static void Main(string[] args)
        {
            ...
            }).GroupBy(e => e.school, (k, g) => new {school = k, student = g.Select(r => r.student)/*.OrderBy(r => r.student)*/, studCount = g.Count()/*, year = g.OrderBy(r => r.year)*//*.First()/* g.Select(r => r.year)*/ })/*.Select(e => e.)*//*OrderBy(e => e.school).Select(e => e.school + " " + e.studCount + " " + e.student.First())*/;
