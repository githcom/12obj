...
namespace _12obj
{
    internal class Program
    {
        ...
        private static void Main(string[] args)
        {
            ...
            }).GroupBy(e => e.school, (k, g) => new {school = k, year = /*g.Select(r => r.student)*/g.OrderBy(r => r.year)/*, year = g.OrderBy(r => r.year)*//*.First()/* g.Select(r => r.year)*/ })/*.Select(e => e.)*//*OrderBy(e => e.school).Select(e => e.school + " " + e.studCount + " " + e.student.First())*/;
