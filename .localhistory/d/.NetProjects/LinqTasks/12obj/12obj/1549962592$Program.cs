...
namespace _12obj
{
    internal class Program
    {
        ...
        private static void Main(string[] args)
        {
            ...
            var res5 = res113.Join(res213, q => q.floor, w => w.floor, (q, w) => new { floor = w.floor, debt1 = q.debt.Concat(w.debt), /*q.elem.Select(r => r.debt)*/  }).SelectMany(e => e.debt1, (q,w) => q.floor + " " + w);
