    ...
    internal class Program
    {
        ...
        private static void Main(string[] args)
        {
            ...
            var res6 = res113.GroupJoin(res213, q => q.floor, w => w.floor,
                (a1, a2) => new {floor = a1.floor, debt = a1.debt.DefaultIfEmpty() /*.Concat(a2.Select(t => t.debt))*/}).Select(e => e.floor)/*SelectMany(e => e.debt, (ee, d) => (ee.floor != 0 ? ee.floor : 0) + " " + (d != 0f ? d : 0f))*/;
