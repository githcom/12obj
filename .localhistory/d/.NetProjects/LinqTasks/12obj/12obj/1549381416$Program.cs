...
namespace _12obj
{
    internal class Program
    {
        ...
        private static string[] arr = new[] { "Юрьев 1995 68", "Иванова 2008 57", "Алексеева 2009 25", "Кузнецова 2010 2", "Семенова 2001 2", "Юрьева 2001 68", "Пономарев 1996 7", "Семенова 2002 25", "Кондратьев 1996 57", "Алексеева 1990 68", "Сорокина 2006 7" };
        ...
        private static void Main(string[] args)
        {
            ...
            }).GroupBy(e => e.school, (k, g) => new {school = k, student = g.Select(r => r.student), studCount = g.Count(), year = g.OrderBy(r => r.year).First()/* g.Select(r => r.year)*/ }).Select(e => e.school + " " + e.studCount + " " + e.student.First());
