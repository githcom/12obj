...
namespace _12obj
{
    internal class Program
    {
        ...
        private static string[] arr = new[] { "82 Зайцев 1020.00", "142 Иванова 880.00", "25 Степанов 140.00", "69 Пастухов 580.00", "138 Леонидов 240.00", "141 Петров 740.00", "117 Пономарев 240.00", "121 Петухов 1000.00", "139 Иванова 380.00", "75 Сидоров 460.00", "43 Петухов 1020.00", "77 Волкова 900.00", "33 Греков 260.00", "123 Александров 980.00" };
        ...
        private static void Main(string[] args)
        {
            ...
            {
                string[] s = e.Split(' ');
                return new {flat = int.Parse(s[0]), debt = float.Parse(s[2], CultureInfo.InvariantCulture) };
            }).OrderBy(e => e.flat);

            var res1 = res.Where(e => e.flat <= 36).Select(e => new {entr = 1, debt = e.debt}).GroupBy(e => e.entr, (k, g) => new {entr = k, countDebt = g.Count(), avg = g.Average(r => r.debt)});
