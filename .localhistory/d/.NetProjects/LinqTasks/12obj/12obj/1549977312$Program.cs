    ...
    internal class Program
    {
        ...
        private static void Main(string[] args)
        {
            ...
            var res113 = res112.GroupBy(e => (e.flat - 1) / 4,
                (k, g) => new { /*floor = ++floor1,*/ flatAll = g.Select(r => r.flat), elem = g.Select(r => r.e), flat = g.Select(r => r.e.flat), debt = g.Select(r => r.e.debt).DefaultIfEmpty() }).Select((e, i) => new { floor = i + 1, flatAll = e.flatAll, elem = e.elem, flat = e.flat, debt = e.debt });
            ...
            var res5 = res113.GroupJoin(res213, q => q.floor, w => w.floor, (a1, a2) => new { floor = a1.floor, debt1 = a1.debt.Select(r => r).DefaultIfEmpty()/*, debt2 = a2.Select(t => t.debt) */})/*.Select(e => e.floor)*//*.Select(e => e.)*/ .SelectMany(e => e.debt1, (ee, d) => ee.floor + " " + (d != 0f ? d : 0f));
