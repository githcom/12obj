...
namespace _12obj
{
    internal class Program
    {
        ...
        private static void Main(string[] args)
        {
            ...
            }).GroupBy(e => new {e.year, e.school},  (k, g) => new { year = k.year, school = k.school, student = g.Select(r => r.student), countStud = g.Count()}).OrderByDescending(e => e.year).ThenBy(e => e.school).Select(e => e.year + " " + e.school + " " + e.countStud);
