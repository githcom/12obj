...
namespace _12obj
{
    internal class Program
    {
        ...
        // 15 obj //private static string[] arr = new[] { "72 2007 Петухов", "49 1993 Петухов", "6 1997 Петровский", "97 1993 Сорокина", "99 2005 Юрьева", "41 1998 Петухов", "47 2010 Зайцев", "1 2007 Марченко", "84 2008 Алексеева", "49 2008 Греков", "87 2000 Кузнецов", "55 2006 Борисова", "29 1990 Юсов" };
        ...
        private static void Main(string[] args)
        {
            ...
            }).GroupBy(e => e.year, (k, g) => new {year = k, month = g.Count()});

            var res2 = res.Max(e => e.month);

            var res3 = res.Count(e => res2 == e.month);
