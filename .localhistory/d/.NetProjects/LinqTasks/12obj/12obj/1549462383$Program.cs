...
namespace _12obj
{
    internal class Program
    {
        ...
        private static void Main(string[] args)
        {
            ...
            }).GroupBy(e => e.school, (k, g) => new {school = k, year = /*g.Select(r => r.student)*/g.Select(r => r.year)/*, year = g.OrderBy(r => r.year)*//*.First()/* g.Select(r => r.year)*/ }).OrderBy(e => e.year.Select(t => t)).OrderBy(e => e.school)/*.Select(e => e.)*//*OrderBy(e => e.school).Select(e => e.school + " " + e.studCount + " " + e.student.First())*/;

            //var res2 = res.Max(e => e.school);

            var res3 = res.SelectMany(e => e.year.ToString(), (e, y) => e.school + " " + y);
