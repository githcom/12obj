    ...
    internal class Program
    {
        ...
        private static void Main(string[] args)
        {
            ...
            var res213 = res212.GroupBy(e => (e.flat - 1) / 4,
                (k, g) => new { /*floor = ++floor2,*/ flatAll = g.Select(r => r.flat), elem = g.Select(r => r.e), flat = g.Select(r => r.e.flat), debt = g.Select(r => r.e.debt) }).Select((e, i) => new { floor = i, flatAll = e.flatAll, elem = e.elem, flat = e.flat, debt = e.debt});
