...
namespace _12obj
{
    internal class Program
    {
        ...
        private static void Main(string[] args)
        {
            ...
            var res1 = res.Where(e => e.flat <= 36).Select(e => new {entr = 1, debt = e.debt}).GroupBy(e => e.entr, (k, g) => new {entr = k, debt = g.Sum(r => r.debt)});
            ...
            var res77 = res1.Concat(res2).Concat(res3).Concat(res4).GroupBy(e => e.entr, (k, g) => new { entr = k, debt = g.Max(r => r.debt)}).Select(e => e.entr + " " + e.debt);
