...
namespace _12obj
{
    internal class Program
    {
        ...
        private static string[] arr = new[] { "1995 9 Кузнецов", "2004 69 Федченко", "1991 63 Лысенко", "1991 23 Борисова", "2010 79 Семенов", "2001 60 Петров", "2001 68 Иванов", "2004 77 Якимов", "1999 98 Демидов", "1999 45 Якимов" };
        ...
        private static void Main(string[] args)
        {
            ...
            }).GroupBy(e => e.year, (k, g) => new {year = k, school = g.Count()});
