...
namespace _12obj
{
    internal class Program
    {
        ...
        private static void Main(string[] args)
        {
            ...
            var res5 = res113.GroupJoin(res213, q => q.floor, w => w.floor, (a1, a2) => new { floor = a1.floor, debt1 = a1.debt, debt2 = a2.Select(t => t.debt) }).SelectMany(e => e.debt1, (ee, d) => ee.floor + " " + (d != 0f ? d : 0f));
